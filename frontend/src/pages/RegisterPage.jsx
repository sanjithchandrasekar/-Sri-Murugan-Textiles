...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      import('react-hot-toast').then(({ default: toast }) => toast.error('Registration failed. Please try again.'))
    }
    setLoading(false)
  }
    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #fdf8f5 0%, #fff5f5 100%)' }}>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Join Sri Murugan Textiles</p>
        </div>
